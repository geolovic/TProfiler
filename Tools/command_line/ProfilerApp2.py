...
parser.add_argument("in_file", help="Input file with profile data")
parser.add_argument("-g", "--graph",  help="Field with id numbers in river shapefile", action="store_true")
parser.add_argument("-q", "--qgis",  help="Field with names in river shapefile", action="store_true")
parser.add_argument("-sr", "--slopereg", type=int, default=0, help="Regresion points to calculate slopes")
parser.add_argument("-kr", "--ksnreg", type=int, default=0, help="Regresion points to calculate ksn values")
...
qgis_file = args.qgis
is_graph = args.graph
slope_reg_points = args.slopereg
ksn_reg_points = args.ksnreg
