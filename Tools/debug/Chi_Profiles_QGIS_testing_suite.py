...
from Chi_Profiles_QGIS import main
import time


def test_00():
    """
    Test 00 for Chi_Profiles [QGIS Version]
    Ejecuta Chi_Profiles con un shapefile de rios

    """
    inicio = time.time()
    print("=" * 40)
    print("Test 00 para Chi_Profiles [QGIS Version]")
    ...
    out_file = "../data/out/perfiles_rios.dat"
    id_field = "id"
    name_field = "name"
    thetaref = 0.45
    reg_points = 10
...
def test_01():
    """
    Test 01 for Chi_Profiles [QGIS Version]
    ...
    out_file = "../data/out/Chi_Profiles_QGIS_test01.dat"
    id_field = "id"
    name_field = "name"
    thetaref = 0.45
    reg_points = 10
